...
public class ScaleTestCaseTranslator {
  ...
  public static ItemDto translateTestCase(String projectCode, ScaleTestCase testCase) {
  ...
  private static Set<String> getIssueVersions(ScaleTestCase testCase, String projectCode) {
    ...
    for (String potentialVersion : potentialVersions) {
      for (String version : potentialVersion.split(",\\s+")) {
